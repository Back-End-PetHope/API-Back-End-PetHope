...
public interface UserApi {
    ...
    @Operation(
            summary = UserApi.GET_SUMARIO_USER,
            description = UserApi.GET_DESCRICAO_USER
    )
    @ApiResponses({
    ...
    @Operation(
            summary = UserApi.GET_SUMARIO_USERBYID,
            description = UserApi.GET_DESCRICAO_USERBYID
    )
    @ApiResponses({
            @ApiResponse(responseCode = "200",description = UserApi.RESPONSE_200),
            @ApiResponse(responseCode = "404",description = UserApi.RESPONSE_404),
    ...
    @Operation(
            summary = UserApi.POST_SUMARIO_USER,
            description = UserApi.POST_DESCRICAO_USER
    )
    @ApiResponses({
    ...
    @Operation(
            summary = UserApi.POST_SUMARIO_CLINICA,
            description = UserApi.POST_DESCRICAO_CLINICA
    )
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = UserApi.RESPONSE_201),
            @ApiResponse(responseCode = "422", description = UserApi.RESPONSE_422),
    ...
    @Operation(
            summary = UserApi.POST_SUMARIO_ONG,
            description = UserApi.POST_DESCRICAO_ONG
    )
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = UserApi.RESPONSE_201),
            @ApiResponse(responseCode = "422", description = UserApi.RESPONSE_422),
